...
type NavigationProp = NativeStackNavigationProp<EventStackParamList, 'EditEvent'>;
type RoutePropType = RouteProp<EventStackParamList, 'EditEvent'>;
...
export default function EditEventScreen() {
    ...
    const loadEvent = async () => {
      try {
        ...
        if (response.success && response.data) {
          ...
          setEventTypeId(eventData.eventType.id);
  ...
  }, [eventId, name, eventDate, eventTypeId, eventCategory, notes, navigation]);

...
-- Dumping data for table customer_management_db.event_customers: ~3 rows (approximately)
...
-- Dumping data for table customer_management_db.gifts: ~3 rows (approximately)

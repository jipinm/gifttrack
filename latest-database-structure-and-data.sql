...
-- Dumping data for table customer_management_db.care_of_options: ~15 rows (approximately)
INSERT INTO `care_of_options` (`id`, `name`, `is_active`, `is_default`, `created_by`, `created_at`) VALUES
	(1, 'Self', 1, 1, NULL, '2026-02-14 07:44:11'),
	(2, 'Father', 1, 0, NULL, '2026-02-14 07:44:11'),
	(3, 'Mother', 1, 0, NULL, '2026-02-14 07:44:11'),
	(4, 'Brother', 1, 0, NULL, '2026-02-14 07:44:11'),
	(5, 'Sister', 1, 0, NULL, '2026-02-14 07:44:11'),
	(6, 'Son', 1, 0, NULL, '2026-02-14 07:44:11'),
	(7, 'Daughter', 1, 0, NULL, '2026-02-14 07:44:11'),
	(8, 'Others', 1, 0, NULL, '2026-02-14 07:44:11'),
	(9, 'Friend', 1, 0, NULL, '2026-02-15 07:12:53'),
	(10, 'Jipin mohan', 1, 0, '23176fe7-0a50-11f1-b752-7008945b491c', '2026-02-23 18:13:41'),
	(11, 'Ameya', 1, 0, '23176fe7-0a50-11f1-b752-7008945b491c', '2026-02-23 18:13:48'),
	(12, 'Ayush', 1, 0, '23176fe7-0a50-11f1-b752-7008945b491c', '2026-02-23 18:13:54'),
	(13, 'Siper 1', 1, 0, '7e2ac996-01bb-11f1-9edc-7008945b491c', '2026-02-24 01:53:46'),
	(14, 'Super 2', 1, 0, '7e2ac996-01bb-11f1-9edc-7008945b491c', '2026-02-24 01:53:54'),
	(15, 'My care of one', 1, 0, '5ec8d2bb-1126-11f1-9832-7008945b491c', '2026-02-24 02:15:08'),
	(16, 'My care of two', 1, 0, '5ec8d2bb-1126-11f1-9832-7008945b491c', '2026-02-24 02:15:16');
...
INSERT INTO `gifts` (`id`, `event_id`, `customer_id`, `gift_type_id`, `value`, `description`, `created_at`, `updated_at`) VALUES
	...
	('b3032dbe-1e5e-e852-00a9-3c07de6de717', 'c3a42b1a-9995-00e9-9a15-693c890b1188', '2fd8ccbf-0ab1-11f1-830b-7008945b491c', 1, 4258.00, NULL, '2026-02-19 04:01:40', '2026-02-19 04:01:40'),
...
INSERT INTO `users` (`id`, `name`, `mobile_number`, `password`, `address`, `state_id`, `district_id`, `city_id`, `place`, `branch`, `role`, `created_at`, `updated_at`) VALUES
	...
	('5ec8d2bb-1126-11f1-9832-7008945b491c', 'Admin new one', '7788996655', '$2y$10$SITOB0DFPycMQ.Ok7q6gFOxv.RfSIR6NqfTC/fepBhNxJ7njwFNCK', 'Admin address', 1, 13, 80, NULL, '', 'admin', '2026-02-24 02:13:12', '2026-02-24 02:13:12'),
